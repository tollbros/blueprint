...
- **Token alignment (colors/spacing/radius/typography/heights)** — **Status:** ✅ uses shared CTA height/padding tokens (`--tb-cta-height-*`, `--tb-cta-padding-base`), global radius, SemanticButtonLabel typography, state/brand palette tokens, disabled token.  
