...
- **Token alignment (colors/spacing/radius/typography/heights)** — **Status:** ✅ uses shared CTAButton height/padding tokens (`--tb-Buttons-CTAButton-height-*`, `--tb-Buttons-CTAButton-padding-base`), global radius, SemanticButtonLabel typography, state/brand palette tokens, disabled token.  
