...
- **Token alignment (colors/spacing/radius/typography)** — **Status:** ✅ uses palette/tokens and shared CTA height/padding vars (`--tb-cta-height-*`, `--tb-cta-padding-base`, global radius, typography tokens).  
