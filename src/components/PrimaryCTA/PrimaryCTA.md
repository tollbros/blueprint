...
- **Token alignment (colors/spacing/radius/typography)** — **Status:** ✅ uses palette/tokens and shared CTAButton height/padding vars (`--tb-Buttons-CTAButton-height-*`, `--tb-Buttons-CTAButton-padding-base`, global radius, typography tokens).  
